...
export const metadata: Metadata = {
  ...
  keywords: ['Rotterdam oil terminal', 'Houston energy terminal', 'Jurong bulk storage', 'Fujairah tank terminal', 'global petroleum terminals', 'bulk liquid storage'],
  openGraph: {
    title: 'Four Global Energy Terminals — JSF Logistics B.V.',
    description:
      'Strategic deep-water terminals in Rotterdam, Houston, Jurong, and Fujairah. Crude oil, fuel oil, chemicals, and gas products storage across four continents.',
            ...
            <SectionReveal key={t.city} delay={0.05}>
              <div style={{
                ...
                <div style={{ position: 'relative', height: '240px' }}>
                  <Image src={t.image} alt={t.city} fill style={{ objectFit: 'cover' }} sizes="100vw" />
